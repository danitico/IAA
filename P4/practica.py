...
data = arff.load(open('competition-iaa-2018-2019/trainNormalizadoWekasinWSPDnirhum.arff', 'r'))
data1 = arff.load(open('competition-iaa-2018-2019/testNormalizadoWekasinWSPDnirhum.arff', 'r'))
...
#     if array[i][11] == 'Baja':
#         array[i][11] = 0
#     elif array[i][11] == 'Media':
#         array[i][11] = 1
#     elif array[i][11] == 'Moderada':
#         array[i][11] = 2
#     else:
#         array[i][11] = 3
...
#                                verbose=1))
#
# history = model.fit(train_x, train_y, epochs=1000, batch_size=128, verbose=1, validation_data=(val_x, val_y),
#                     callbacks=callbacks)

history = model.fit(array, labels, epochs=80, batch_size=64, verbose=1)
